...
insert into #easypasswords (pw) values ('redmond','microsoft','contoso')

--TODO: Add regional and local references, sports, etc. If you're from Louisiana, for example:
insert into #easypasswords (pw) values ('lsutigers'),('lsu'),('Lsu'),('Lsu'),('mardigras'), ('MardiGras'),('whodat'),('nola'),('saints')
...
--Add all database user names to the rainbow
...
--Add names of SQL logins, the server name, databases, credentials, and other objects
insert into #easypasswords (pw) 
...
--Add common shortenings of existing rainbow items
insert into #easypasswords (pw)
...
--Add common character replacement/conversions
insert into #easypasswords (pw)
...
--Add different capitalization combinations
insert into #easypasswords (pw)
...
--Add common numeric suffix permutations
insert into #easypasswords (pw)
